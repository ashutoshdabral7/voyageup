...
<html lang="en">
    ...
    <head>
        ...
        <title>Scavanger - <?php echo $title; ?></title>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo base_url('admin/dashboard') ?>">Scavanger - the hunt game</a>
                </div>
                <!-- /.navbar-header -->
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <?php $this->load->view('common/admin_menu.php'); ?>
                    </div>
                    <!-- /.sidebar-collapse -->
                </div>
                <!-- /.navbar-static-side -->
            ...
            <?php display_common_errors($this->merror, $this->msuccess); ?>
            <?php print($content); ?>
